"""
Module for getting information related to Presentaciones.
"""
...
class Presentaciones(Base):
    def __init__(self, config) -> None:
        super().__init__(config=config)

    def add_condition(self, key: Keys.PRESENTACIONES.value, value) -> None:
        """
    ...
    def get_specific_endpoint(self) -> str:
        ...
        """
        return Endpoint.PRESENTACIONES.value
